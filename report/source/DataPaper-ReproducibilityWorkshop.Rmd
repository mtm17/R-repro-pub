---
title: "Data Article: Trier social stress test and food-choice: Behavioral, self-report & hormonal data (Carpentry Workshop Version) - commit test 2 - push 1 try2"
...
#set global options for chunk rendering
...
```{r fig3-heartrate, results=FALSE, eval=TRUE, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Fig 3: Mean heart rate of stress and control groups at baseline and during intervention"}
...
#display the plot created by code in 02_hormone_analysis
plot
```
